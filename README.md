...
퇴사·부서 이동·계약 종료 후 남은 접근 권한을 검토하는 보안 운영 대시보드입니다. **Microsoft Data School 팀 프로젝트에서 ShinDuck이 작성한 Streamlit 대시보드 작업을 선별한 개인 포트폴리오**입니다. 전체 데이터 플랫폼이나 팀원 구현을 개인 성과로 주장하지 않습니다.
...
기준 버전: `0c88146e9c5e8c7e83becb3d1d847ad91861de6c` — 본인 작성 대시보드 UI 정리 커밋. [PR #81](https://github.com/dataschool-proj2-team5/access-drift/pull/81)의 개별 커밋 작성자가 ShinDuck인 초기 구현을 사용했습니다. 이후 공동 작성·팀원 병합·실데이터 연동 변경은 포함하지 않았습니다.
